<template>
  <div>
    <transition-group name="list" tag="ul">
      <!-- 구조분해할당 문법 적용 -->
      <li v-for="({ completed, todo }, index) in todos" v-bind:key="index" class="shadow">
        <i class="fa-solid fa-check checkBtn" v-bind:class="{ checkBtnCompleted: completed }"
           v-on:click="toggleComplete(todo, index)"></i>
